...
# ฐานข้อมูลจำลองจัดเก็บประวัติข้อมูลลูกค้าในระบบหลังบ้าน
db_submissions = []

# CONFIG: ตั้งค่าความปลอดภัยระบบหลังบ้าน
ADMIN_PASSWORD = "tao2026_secure"  # <-- เปลี่ยนรหัสผ่านแอดมินตรงนี้ได้ตามต้องการ
LINE_TOKEN = "YOUR_LINE_NOTIFY_TOKEN"  # <-- นำ Token LINE Notify มาใส่ตรงนี้เพื่อรับแจ้งเตือนทันที
...
# สไตล์ดีไซน์ Cyberpunk นีออนเรืองแสง ฝังในเครื่อง 100% ไม่ต้องง้ออินเทอร์เน็ต
STYLE = """
<style>
...
# =====================================================================
# [โซนที่ 1: ระบบหน้าบ้านสำหรับลูกค้า] - ลูกค้าเห็นแค่ส่วนนี้เท่านั้น
# =====================================================================
...
# =====================================================================
# [โซนที่ 2: ระบบหลังบ้านสำหรับแอดมินเท่านั้น] - ลิงก์ลับ + ล็อกรหัสผ่าน
# =====================================================================

# ลิงก์ลับสำหรับเข้าหน้าล็อกอินหลังบ้าน (ลูกค้าจะไม่เห็นปุ่มนี้บนหน้าเว็บ)
...
def admin_login():
    ...
    if request.method == 'POST':
        ...
        if pwd == ADMIN_PASSWORD:
            # หากรหัสถูกต้อง ให้เปิดหน้า Dashboard หลังบ้านทันที
            html = f"""
